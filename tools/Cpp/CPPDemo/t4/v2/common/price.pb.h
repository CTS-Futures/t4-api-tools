...
#ifndef t4_2fv2_2fcommon_2fprice_2eproto_2epb_2eh
#define t4_2fv2_2fcommon_2fprice_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_t4_2fv2_2fcommon_2fprice_2eproto
...
struct TableStruct_t4_2fv2_2fcommon_2fprice_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_t4_2fv2_2fcommon_2fprice_2eproto;
}  // extern "C"
namespace t4proto {
namespace v2 {
namespace common {
...
/* @@protoc_insertion_point(class_definition:t4proto.v2.common.Price) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "t4proto.v2.common.Price"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:t4proto.v2.common.Price)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_t4_2fv2_2fcommon_2fprice_2eproto;
};
...
/* @@protoc_insertion_point(class_definition:t4proto.v2.common.Decimal) */ {
 public:
 ...
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "t4proto.v2.common.Decimal"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:t4proto.v2.common.Decimal)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<0, 1,
...
inline const ::std::string& Decimal::value() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:t4proto.v2.common.Decimal.value)
...
PROTOBUF_ALWAYS_INLINE void Decimal::set_value(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:t4proto.v2.common.Decimal.value)
}
inline ::std::string* PROTOBUF_NONNULL Decimal::mutable_value()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_value();
  // @@protoc_insertion_point(field_mutable:t4proto.v2.common.Decimal.value)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Decimal::release_value() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:t4proto.v2.common.Decimal.value)
...
inline void Decimal::set_allocated_value(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:t4proto.v2.common.Decimal.value)
}
...
inline const ::std::string& Price::value() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:t4proto.v2.common.Price.value)
  return _internal_value();
}
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void Price::set_value(Arg_&& arg, Args_... args) {
  ...
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.value_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:t4proto.v2.common.Price.value)
}
inline ::std::string* PROTOBUF_NONNULL Price::mutable_value()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_value();
  // @@protoc_insertion_point(field_mutable:t4proto.v2.common.Price.value)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Price::release_value() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:t4proto.v2.common.Price.value)
  if ((_impl_._has_bits_[0] & 0x00000001u) == 0) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
...
inline void Price::set_allocated_value(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:t4proto.v2.common.Price.value)
}
...
#endif  // t4_2fv2_2fcommon_2fprice_2eproto_2epb_2eh
