...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {43, sizeof(::t4proto::v1::service::Heartbeat)},
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 27, 27, 0, 21>
ServerMessage::_table_ = {
  {
    ...
    {PROTOBUF_FIELD_OFFSET(ServerMessage, _impl_.payload_.order_update_), _Internal::kOneofCaseOffset + 0, 20,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .t4proto.v1.orderrouting.OrderUpdateMulti order_update_multi = 301;
    {PROTOBUF_FIELD_OFFSET(ServerMessage, _impl_.payload_.order_update_multi_), _Internal::kOneofCaseOffset + 0, 21,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .t4proto.v1.orderrouting.OrderUpdateFailed order_update_failed = 302;
    {PROTOBUF_FIELD_OFFSET(ServerMessage, _impl_.payload_.order_update_failed_), _Internal::kOneofCaseOffset + 0, 22,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .t4proto.v1.orderrouting.OrderUpdateStatus order_update_status = 303;
    {PROTOBUF_FIELD_OFFSET(ServerMessage, _impl_.payload_.order_update_status_), _Internal::kOneofCaseOffset + 0, 23,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .t4proto.v1.orderrouting.OrderUpdateTrade order_update_trade = 304;
    {PROTOBUF_FIELD_OFFSET(ServerMessage, _impl_.payload_.order_update_trade_), _Internal::kOneofCaseOffset + 0, 24,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .t4proto.v1.orderrouting.OrderUpdateTradeLeg order_update_trade_leg = 305;
    {PROTOBUF_FIELD_OFFSET(ServerMessage, _impl_.payload_.order_update_trade_leg_), _Internal::kOneofCaseOffset + 0, 25,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
    // .t4proto.v1.orderrouting.CreateUDSResponse create_uds_response = 340;
    {PROTOBUF_FIELD_OFFSET(ServerMessage, _impl_.payload_.create_uds_response_), _Internal::kOneofCaseOffset + 0, 26,
    (0 | ::_fl::kFcOneof | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
      {::_pbi::TcParser::GetTable<::t4proto::v1::service::Heartbeat>()},
