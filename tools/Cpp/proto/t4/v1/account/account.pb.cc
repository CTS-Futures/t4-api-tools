...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {9, sizeof(::t4proto::v1::account::AccountSubscribeResponse)},
        {16, sizeof(::t4proto::v1::account::AccountCurrency)},
        {25, sizeof(::t4proto::v1::account::AccountPosition)},
        {108, sizeof(::t4proto::v1::account::AccountUpdate)},
        {161, sizeof(::t4proto::v1::account::AccountDetails)},
        {236, sizeof(::t4proto::v1::account::AccountSnapshotMessage)},
        {245, sizeof(::t4proto::v1::account::AccountSnapshot)},
};
...
AccountSubscribe::AccountSubscribe(
  ...
  ::memcpy(reinterpret_cast<char *>(&_impl_) +
           ...
           reinterpret_cast<const char *>(&from._impl_) +
               offsetof(Impl_, subscribe_),
           offsetof(Impl_, subscribe_all_accounts_) -
               offsetof(Impl_, subscribe_) +
               sizeof(Impl_::subscribe_all_accounts_));
...
void AccountSubscribe::InternalSwap(AccountSubscribe* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AccountSubscribe, _impl_.subscribe_all_accounts_)
      + sizeof(AccountSubscribe::_impl_.subscribe_all_accounts_)
