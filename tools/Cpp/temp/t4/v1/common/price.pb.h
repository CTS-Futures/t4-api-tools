...
/* @@protoc_insertion_point(class_definition:t4proto.v1.common.Decimal) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Decimal* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Decimal* New(::google::protobuf::Arena* arena = nullptr) const {
...
inline std::string* Price::mutable_value() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_value();
