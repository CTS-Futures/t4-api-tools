...
/* @@protoc_insertion_point(class_definition:t4proto.v1.service.ServerMessage) */ {
 ...
 public:
  ...
  [[nodiscard]] ::t4proto::v1::account::AccountProfit* PROTOBUF_NULLABLE release_account_profit();
  ::t4proto::v1::account::AccountProfit* PROTOBUF_NONNULL mutable_account_profit();
  void set_allocated_account_profit(::t4proto::v1::account::AccountProfit* PROTOBUF_NULLABLE value);
  void unsafe_arena_set_allocated_account_profit(::t4proto::v1::account::AccountProfit* PROTOBUF_NULLABLE value);
  ::t4proto::v1::account::AccountProfit* PROTOBUF_NULLABLE unsafe_arena_release_account_profit();

  private:
  const ::t4proto::v1::account::AccountProfit& _internal_account_profit() const;
  ::t4proto::v1::account::AccountProfit* PROTOBUF_NONNULL _internal_mutable_account_profit();
  ...
  [[nodiscard]] ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NULLABLE release_account_position_profit();
  ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NONNULL mutable_account_position_profit();
  void set_allocated_account_position_profit(::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NULLABLE value);
  void unsafe_arena_set_allocated_account_position_profit(::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NULLABLE value);
  ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NULLABLE unsafe_arena_release_account_position_profit();

  private:
  const ::t4proto::v1::account::AccountPositionProfit& _internal_account_position_profit() const;
  ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NONNULL _internal_mutable_account_position_profit();
 ...
 private:
  ...
  inline void clear_has_payload();
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<0, 29,
                                   29, 0,
                                   21>
      _table_;
...
inline ::t4proto::v1::account::AccountProfit* PROTOBUF_NULLABLE ServerMessage::release_account_profit() {
  // @@protoc_insertion_point(field_release:t4proto.v1.service.ServerMessage.account_profit)
  if (payload_case() == kAccountProfit) {
    clear_has_payload();
    auto* temp = reinterpret_cast<::t4proto::v1::account::AccountProfit*>(_impl_.payload_.account_profit_);
    if (GetArena() != nullptr) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::t4proto::v1::account::AccountProfit& ServerMessage::_internal_account_profit() const {
  return payload_case() == kAccountProfit ? *reinterpret_cast<::t4proto::v1::account::AccountProfit*>(_impl_.payload_.account_profit_) : reinterpret_cast<::t4proto::v1::account::AccountProfit&>(::t4proto::v1::account::_AccountProfit_default_instance_);
}
...
inline ::t4proto::v1::account::AccountProfit* PROTOBUF_NULLABLE ServerMessage::unsafe_arena_release_account_profit() {
...
inline void ServerMessage::unsafe_arena_set_allocated_account_profit(
    ::t4proto::v1::account::AccountProfit* PROTOBUF_NULLABLE value) {
  // We rely on the oneof clear method to free the earlier contents
  // of this oneof. We can directly use the pointer we're given to
  // set the new value.
  clear_payload();
...
inline ::t4proto::v1::account::AccountProfit* PROTOBUF_NONNULL ServerMessage::_internal_mutable_account_profit() {
  if (payload_case() != kAccountProfit) {
    clear_payload();
    set_has_account_profit();
  ...
  return reinterpret_cast<::t4proto::v1::account::AccountProfit*>(_impl_.payload_.account_profit_);
}
inline ::t4proto::v1::account::AccountProfit* PROTOBUF_NONNULL ServerMessage::mutable_account_profit()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NULLABLE ServerMessage::release_account_position_profit() {
  ...
  if (payload_case() == kAccountPositionProfit) {
    clear_has_payload();
    auto* temp = reinterpret_cast<::t4proto::v1::account::AccountPositionProfit*>(_impl_.payload_.account_position_profit_);
    if (GetArena() != nullptr) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::t4proto::v1::account::AccountPositionProfit& ServerMessage::_internal_account_position_profit() const {
  return payload_case() == kAccountPositionProfit ? *reinterpret_cast<::t4proto::v1::account::AccountPositionProfit*>(_impl_.payload_.account_position_profit_) : reinterpret_cast<::t4proto::v1::account::AccountPositionProfit&>(::t4proto::v1::account::_AccountPositionProfit_default_instance_);
}
...
inline ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NULLABLE ServerMessage::unsafe_arena_release_account_position_profit() {
...
inline void ServerMessage::unsafe_arena_set_allocated_account_position_profit(
    ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NULLABLE value) {
  // We rely on the oneof clear method to free the earlier contents
  // of this oneof. We can directly use the pointer we're given to
  // set the new value.
  clear_payload();
...
inline ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NONNULL ServerMessage::_internal_mutable_account_position_profit() {
  if (payload_case() != kAccountPositionProfit) {
    clear_payload();
    set_has_account_position_profit();
  ...
  return reinterpret_cast<::t4proto::v1::account::AccountPositionProfit*>(_impl_.payload_.account_position_profit_);
}
inline ::t4proto::v1::account::AccountPositionProfit* PROTOBUF_NONNULL ServerMessage::mutable_account_position_profit()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
